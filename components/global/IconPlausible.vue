<template>
  <svg width="1000px" height="1000px" viewBox="0 0 1000 1000" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    ...
    <defs>
      <radialGradient id="radialGradient-1" cx="79.1305263%" cy="87.6448158%" fx="79.1305263%" fy="87.6448158%" r="96.9897763%">
        <stop stop-color="#2440E6" offset="0%" />
        <stop stop-color="#5661B3" offset="100%" />
      </radialGradient>
      <radialGradient id="radialGradient-2" cx="0%" cy="30.2198829%" fx="0%" fy="30.2198829%" r="62.2688936%" gradientTransform="translate(0.000000,0.302199),scale(1.000000,0.722519),rotate(61.734530),translate(-0.000000,-0.302199)">
